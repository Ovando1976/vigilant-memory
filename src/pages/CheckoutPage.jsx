...
import {
 Container, Grid, Paper, Typography, Stack, Divider, Button, Chip, Alert, CircularProgress
} from "@mui/material";
          ...
          <Paper sx={{ p: 3 }}>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
                Pay securely with Stripe. We support Apple Pay / Google Pay, Link, cards, ACH, and more.
              </Typography>
          ...
          <Paper sx={{ p: 3 }}>
            ...
            <Stack spacing={1.5} sx={{ mt: 2 }}>
              ...
              <Alert severity="info" sx={{ mt: 2 }}>
                Use Stripe test cards like <strong>4242 4242 4242 4242</strong> in test mode.
              </Alert>
